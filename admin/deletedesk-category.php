...
if(isset($_GET['id']) && isset($_GET['img_name'])){
    ...
    if($risk==true){
        $_SESSION['delete'] = "<div class='success' style='color:#5dac51;'>Category Deleted Successfully.</div>";
        header("Location: " . SITEURL . 'admin/managedesk-category.php');
        exit();
    }
    else{
        $_SESSION['delete'] = "<div class='error' style='color:rgb(255,0,0)'>Failed to Delete Category: " . mysqli_error($conn) . "</div>";
        header("Location: " . SITEURL . 'admin/managedesk-category.php');
        exit();
    }
}
